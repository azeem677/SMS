...
const Navbar = ({ setIsSidebarOpen }) => {
    ...
    return (
        <div className="md:w-full  bg-white dark:bg-zinc-900 border-b border-gray-200 dark:border-zinc-800 px-6 xl:px-16 py-3 flex-shrink-0">
            <div className="flex  items-center  max-w-6xl mx-auto">
                ...
                <div className="flex items-center ml-2 gap-3">
                    ...
                    {/* Theme Toggle */}
                    <button onClick={() => dispatch(toggleTheme())} className="size-8 md:flex hidden items-center justify-center bg-white dark:bg-zinc-800 shadow rounded-lg transition hover:scale-105 active:scale-95">
                        {
                            theme === "light"
